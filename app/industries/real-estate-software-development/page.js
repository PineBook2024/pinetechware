...
export default function page() {
    ...
    const DesignServices = [
        {
            ...
            description:
                "Our team understands real estate workflows, market dynamics, and customer expectations to deliver effective real estate software solutions.",
        },
        {
            title: "Custom-Built Solutions",
            description:
                "We develop tailored software solutions aligned with your business goals, operational processes, and client requirements.",
        },
        {
            title: "Scalability & Performance",
            description:
                "Our solutions are built to handle growing property listings, user base, and transactions without compromising performance.",
        },
        {
            title: "QA & Testing",
            description:
                "Rigorous quality assurance and testing ensure software reliability, optimal performance, and robust data security.",
        },
    ];
    ...
    const bullets = [
        "Real Estate Software Developers & QA Engineers",
        ...
        <div>
            ...
            <section className="bg-gray-50">
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">Why Choose Us for Real Estate Software Development</h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for Real Estate Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                    We offer flexible engagement models to meet diverse real estate technology requirements.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Real Estate Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Strengthen your real estate technology initiatives with skilled professionals who integrate seamlessly with your team.
                            </p>
