...
import Img1 from "@/public/images/banner-inner/ecommerce-software-development-banner.webp";
   ...
   const DesignServices = [
    {
        ...
        description:
            "Our team understands ecommerce ecosystems, consumer behavior, and digital commerce trends.",
    },
    {
        title: "Custom-Built Solutions",
        description:
            "Every ecommerce solution is tailored to meet your business goals and customer expectations.",
    },
    {
        title: "Security & Compliance",
        description:
            "We implement advanced security measures to protect customer data and transactions.",
    },
    {
        title: "QA & Testing",
        description:
            "Comprehensive testing ensures high performance, reliability, and scalability.",
    },
    {
        title: "Cloud-Based Ecommerce Solutions",
        description:
            "We develop cloud-enabled ecommerce platforms that support scalability, speed, and global reach.",
    },
];
                        ...
                        <div className="lg:col-span-7">
                            ...
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We deliver scalable, secure, and high-performing ecommerce software development services designed to help businesses sell smarter, grow faster, and deliver seamless customer experiences across digital channels.</p>
                                                ...
                                                <div  className="lg:col-span-5 flex justify-center items-center mt-10 lg:mt-0 rounded-4xl">
                                                               <Image
                                                                   src="/images/ecommerce-software-development/01.webp"
                                                                   alt="Ecommerce Software Development Services"
                                                                   width={500}
                                                                   height={500}
                                                               ...
                                                               <Image  src="/images/ecommerce-software-development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Ecommerce Software Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
                ...
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                            Why Choose Us for Ecommerce Software Development</h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for Ecommerce Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                   We offer flexible engagement models to suit your business needs and project scope.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Ecommerce Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Boost your ecommerce development capabilities with skilled professionals who integrate seamlessly with your team.
                            </p>
