...
export default function page() {
    ...
    const DesignServices = [
        {
            ...
            description:
                "Our team consists of automotive technology specialists with deep industry knowledge, ensuring solutions that align with performance, compliance, and innovation standards.",
        },
        {
            title: "Custom Solutions",
            description:
                "We build tailor-made software solutions designed to meet specific automotive requirements, delivering optimal efficiency and measurable results.",
        },
        {
            title: "Data Security",
            description:
                "We implement advanced security measures to protect sensitive vehicle data and ensure compliance with automotive cybersecurity standards.",
        },
        {
            title: "QA & Testing",
            description:
                "Comprehensive quality assurance and testing processes guarantee reliable, scalable, and high-performance automotive software solutions.",
        },
        {
            title: "Digital Cockpits",
            description:
                "We develop intelligent digital cockpit solutions that integrate infotainment, navigation, and driver assistance into a unified, interactive dashboard.",
        },
        {
            title: "Effective Onboarding",
            description:
                "Our streamlined onboarding process ensures a smooth transition, faster integration, and improved productivity for development teams and stakeholders.",
        },
    ];
    ...
    const bullets = [
        "Expertise in Embedded Systems, ADAS, Infotainment, and Mobility Solutions",
        "On-demand Engineers, Architects, and Testers",
        "Seamless Integration with In-House Teams",
        "Reduced Recruitment Costs without Compromising Quality",
        "Compliance with ISO 26262, AUTOSAR, and Industry Standards",
        "Support for Development, Testing, and Post-Launch Maintenance"
    ];
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Automotive </span> Software Development Services</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We deliver advanced automotive software development services focused on automation, safety, connectivity, and performance. Our solutions empower modern vehicles with intelligent systems that enhance driving experience, operational efficiency, and long-term reliability.</p>
                        </div>
                         <div  className="lg:col-span-5 flex justify-center items-center mt-10 lg:mt-0 rounded-4xl">
                                        <Image
                                            src="/images/automotive-software-development/01.webp"
                                            alt="Automotive Software Development Services"
                                            width={500}
                                            height={500}
                                        ...
                                        <Image  src="/images/automotive-software-development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Automotive Software Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
                ...
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                            Why Choose Us for  <span className="!normal-case">Automotive Software Development</span></h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                ...
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                    We offer flexible collaboration models to support innovation, scalability, and faster time-to-market.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Automotive Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Strengthen your automotive projects with our specialized staff augmentation services. Our experts integrate smoothly with your team to deliver compliant, innovative, and high-quality software.
                            </p>
