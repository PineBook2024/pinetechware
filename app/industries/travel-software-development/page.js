...
export default function page() {
  ...
  const DesignServices = [
  {
    ...
    description:
      "Our team understands travel workflows, seasonal demand, and evolving customer expectations to deliver industry-focused solutions.",
  },
  {
    title: "Custom-Built Solutions",
    description:
      "We develop tailored travel software that aligns perfectly with your business model, operational needs, and long-term goals.",
  },
  {
    title: "Scalability & Performance",
    description:
      "Our solutions are engineered to handle high traffic volumes and peak travel seasons without compromising performance.",
  },
  {
    title: "QA & Testing",
    description:
      "Comprehensive quality assurance and testing ensure reliability, optimal performance, and robust security across all platforms.",
  },
];
...
const bullets = [
  "Travel Software Developers & QA Engineers",
        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Travel  </span> Software Company</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We are a trusted travel software company delivering smart, scalable, and customer-centric digital
                                solutions for travel agencies, tour operators, airlines, hotels, and travel startups. Our software
                                helps automate operations, enhance customer experience, and drive growth in the travel industry.</p>
                        </div>
                                                <div  className="lg:col-span-5 flex justify-center items-center mt-10 lg:mt-0 rounded-4xl">
                                                               <Image
                                                                   src="/images/travel-software-development/01.webp"
                                                               ...
                                                               <Image  src="/images/travel-software-development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Travel Software Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
            ...
            <section className="bg-gray-50">
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">Why Choose Us as Your Travel Software Partner</h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for Travel Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                    We offer flexible engagement models to meet diverse travel technology requirements.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Travel Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Strengthen your travel technology initiatives with experienced professionals who integrate seamlessly with your team.
                            </p>
