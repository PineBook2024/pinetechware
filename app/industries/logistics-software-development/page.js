...
import Img1 from "@/public/images/banner-inner/logistics-software-development-banner.webp";
...
const DesignServices = [
    {
        ...
        description: "Our team understands logistics operations, transportation challenges, and supply chain dynamics."
    },
    {
        title: "Custom-Built Solutions",
        description: "We develop tailored logistics software aligned with your operational goals and business model."
    },
    {
        title: "Scalability & Performance",
        description: "Our solutions are built to scale with growing shipment volumes and business expansion."
    },
    {
        title: "QA & Testing",
        description: "Rigorous testing ensures system reliability, accuracy, and performance."
    },
    {
        title: "Cloud-Based Logistics Software Solutions",
        description: "We develop cloud-enabled logistics platforms that support scalability, remote access, and real-time data availability."
    },
    {
        title: "Integration & Automation",
        description: "We integrate logistics software with existing systems to enable seamless operations."
    },
];
...
const bullets = [
    "Logistics Software Developers & QA Engineers",
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Logistics Software</span> Development Services</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We are a reliable logistics software development company delivering intelligent, scalable, and data-driven digital solutions for logistics providers, transportation companies, freight forwarders, and supply chain businesses. Our solutions help optimize operations, improve visibility, and reduce costs across the logistics ecosystem.</p>
                        </div>
                                                <div  className="lg:col-span-5 flex justify-center items-center mt-10 lg:mt-0 rounded-4xl">
                                                               <Image
                                                                   src="/images/logistics-software-development/01.webp"
                                                                   alt="Logistics Software Development Services"
                                                                   width={500}
                                                                   height={500}
                                                               ...
                                                               <Image  src="/images/logistics-software-development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Logistics Software Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
                ...
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                            Why Choose Us for Logistics Software Development</h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for Logistics Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                  We offer flexible engagement models to meet diverse logistics technology requirements.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Logistics Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Strengthen your logistics technology initiatives with skilled professionals who integrate seamlessly with your team.
                            </p>
