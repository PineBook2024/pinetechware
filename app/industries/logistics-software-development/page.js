                ...
                <div className="px-6 lg:px-8 py-40 lg:py-[10.5rem] max-w-7xl mx-auto">
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            ...
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We are a reliable logistics software Marketing Company delivering intelligent, scalable, and data-driven digital solutions for logistics providers, transportation companies, freight forwarders, and supply chain businesses. Our solutions help optimize operations, improve visibility, and reduce costs across the logistics ecosystem.</p>
                        </div>
