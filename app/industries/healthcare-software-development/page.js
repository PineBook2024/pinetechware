...
import Img1 from "@/public/images/banner-inner/healthcare-software-development-banner.webp";
...
export default function page() {
    ...
    const DesignServices = [
        {
            ...
            description:
                "Our team understands clinical workflows, patient data management, and healthcare compliance standards.",
        },
        {
            title: "Custom-Built Solutions",
            description:
                "We develop tailored healthcare software that aligns with your operational needs and care objectives.",
        },
        {
            title: "Security & Compliance",
            description:
                "We follow industry standards such as HIPAA and ensure robust data security and privacy protection.",
        },
        {
            title: "QA & Testing",
            description:
                "Rigorous testing ensures reliability, accuracy, and safety of healthcare software systems.",
        },
        {
            title: "Cloud-Based Healthcare Solutions",
            description:
                "We develop cloud-enabled healthcare platforms that support scalability, remote access, and secure data management.",
        },
    ];
    ...
    const bullets = [
        "•	Experienced Developers & QA Engineers",
                        ...
                        <div className="lg:col-span-7">
                            ...
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">We provide secure, scalable, and compliant healthcare software development services designed to improve patient care, streamline clinical workflows, and enhance operational efficiency for healthcare providers, hospitals, clinics, and health-tech companies.</p>
                                                 ...
                                                 <div  className="lg:col-span-5 flex justify-center items-center mt-10 lg:mt-0 rounded-4xl">
                                                                <Image
                                                                    src="/images/healthcare-software-development/01.webp"
                                                                ...
                                                                <Image  src="/images/healthcare-software-development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Healthcare Software Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
                ...
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                            Why Choose Us for Healthcare Software Development</h2>
                    </div>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for Healthcare Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                    We offer flexible engagement models to meet diverse healthcare technology requirements.
                                </p>
                            </div>
                        </SplideSlide>
                    ...
                    <div className="md:flex">
                        <div className="w-full xl:w-[60%] lg:w-[55%] md:w-[50%] mr-[5%]">
                            <h2 className="text-black font-bold pb-6 lg:pb-[2.375rem] text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px]">
                                Staff Augmentation for Healthcare Software Development
                            </h2>
                            <p className="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                                Enhance your healthcare technology initiatives with skilled professionals who integrate seamlessly with your team.
                            </p>
