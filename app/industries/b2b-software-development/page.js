...
import Img1 from "@/public/images/banner-inner/b2b-software-development-banner.webp";
                ...
                <div className="px-6 lg:px-8 py-40 lg:py-[10.5rem] max-w-7xl mx-auto">
                    <div className="lg:grid lg:grid-cols-12">
                        ...
                        <div className="!flex lg:mt-0 mt-6 lg:col-span-5 justify-start lg:justify-start items-start">
                            <Image className="w-full" src="/images/b2b-software-development.webp" alt="Top Mobile App Developers" width="500" height="500" />
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <SplideSlide>
                            <div className="mr-16">
                                <h2 className="font-bold pb-6 text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px]">
                                    Collaboration Models for B2B Software Development
                                </h2>
                                <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                                    We offer flexible engagement models to match your project scope, budget, and timeline.
                                </p>
                            </div>
                        </SplideSlide>
