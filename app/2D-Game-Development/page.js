...
export default function page() {
    ...
    const webServices = [
        {
            heading: "Custom 2D Game Development",
            description:
                "End-to-end 2D game development tailored to your concept, genre, and target audience.",
        },
        {
            heading: "Mobile 2D Game Development",
            description:
                "Optimized 2D games for iOS and Android with smooth performance.",
        },
        {
            heading: "2D Art & Animation",
            description:
                "Custom characters, backgrounds, sprites, and animations designed for immersive gameplay.",
        },
        {
            heading: "Unity 2D Game Development",
            description:
                "High-performance 2D games built using Unity’s 2D engine.",
        },
        {
            heading: "Gameplay Mechanics & Level Design",
            description:
                "Engaging mechanics, levels, and progression systems that keep players hooked.",
        },
        {
            heading: "Multiplayer 2D Games",
            description:
                "Online features, leaderboards, and real-time multiplayer integration.",
        },
        {
            heading: "Monetization Integration",
            description:
                "Ads, in-app purchases, rewards, and subscriptions optimized for revenue.",
        },
        {
            heading: "Testing & Optimization",
            description:
                "Bug fixing, performance tuning, and device compatibility testing.",
        },
    ];
    ...
    const processSteps = [
        {
            ...
            desc: "We understand your game idea, target audience, and monetization goals.",
        },
        {
            number: "02",
            title: "Storyboarding & Design",
            desc: "Gameplay flow, characters, levels, and mechanics are planned.",
        },
        {
            number: "03",
            title: "Art & Asset Creation",
            desc: "Custom sprites, environments, animations, and effects are created.",
        },
        {
            number: "04",
            title: "Game Development",
            desc: "Core gameplay, controls, and systems are developed.",
        },
        {
            number: "05",
            title: "Testing & Quality Assurance",
            desc: "Extensive testing ensures stability and smooth performance.",
        },
        {
            number: "06",
            title: "Deployment & Publishing",
            desc: "Publishing support for the App Store and Google Play.",
        },
        {
            number: "07",
            title: "Post-Launch Support & Updates",
            desc: "Updates, enhancements, and long-term maintenance.",
        },
    ];
        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Engaging 2D Games  </span>  With Timeless Visual Appeal</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">2D games continue to dominate mobile and casual gaming due to their simplicity, charm, and strong engagement. We develop high-quality 2D games that combine smooth gameplay, creative visuals, and optimized performance across platforms.</p>
                        </div>
                        <div className="lg:col-span-5 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
                                                              <Image
                                                                  src="/images/2D-Game-Development/01.webp"
                                                                  alt="Professional 2D Game Development Services"
                                                                  width={500}
                                                                  height={500}
                                                                  priority
                                                              ...
                                                              <Image src="/images/2D-Game-Development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Professional 2D Game Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
            ...
            <section className='bg-white'>
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem] ">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Full-Cycle 2D Game Development Services</span></h2></div>
