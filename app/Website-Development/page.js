...
import Img1 from "@/public/images/banner-inner/Website-Development-banner.webp";
    ...
    const webServices = [
        {
            ...
            description:
                "Tailor-made websites built to match your business requirements, functionality needs, and growth goals.",
        },
        {
            heading: "Frontend Development",
            description:
                "Responsive, interactive, and visually accurate interfaces using modern technologies for smooth user experiences.",
        },
        {
            heading: "Backend Development",
            description:
                "Robust server-side development with secure databases, APIs, and scalable architecture.",
        },
        {
            heading: "CMS Development",
            description:
                "Custom and popular CMS solutions that allow easy content management and updates.",
        },
        {
            heading: "E-Commerce Development",
            description:
                "Secure, high-converting online stores with optimized checkout flows and payment integrations.",
        },
        {
            heading: "Web Application Development",
            description:
                "Advanced web applications with dynamic features, dashboards, and user-centric functionality.",
        },
    ];
        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Building Powerful Websites  </span>  That Are Fast, Secure, and Scalable</h1></div>
                        ...
                        <div className="!flex lg:mt-0 mt-6 lg:col-span-5 justify-start lg:justify-start items-start">
                            <Image className="w-full" src="/images/Website-Development22.png" alt="Website Development" width="500" height="500" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='bg-white'>
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem] ">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Full-Cycle Website Development Services</span></h2></div>
