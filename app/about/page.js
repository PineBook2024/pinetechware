    ...
    <div>
      ...
      <section className="bg-white">
        <div className="container mx-auto max-w-7xl px-6 pb-8 pt-14 md:pt-24 lg:pb-24 lg:px-8">
          <div className="max-w-3xl xl:max-w-4xl">
            <div className="lg:overflow-hidden">
              <h2 className="font-bold pb-1 md:pb-0 text-black text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                  ...
                  <div className='pt-8 w-full mt-5 md:ps-12'>
                    <div className=''>
                      ...
                      <div className="flex flex-col gap-5">
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Our culture is built on curiosity, experimentation, and the courage to push boundaries. This spirit empowers us to design innovative products that not only transform industries but also exceed expectations.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">For us, creativity is more than a skill; it’s a mindset. It drives us to see possibilities where others see limits, and it fuels our passion to shape a future filled with opportunity.</p>
 
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">When our talented team collaborates with purpose and passion, extraordinary things happen, and the results speak for themselves.</p>
                ...
                {activeTab === "tab2" && (
                  <div className='pt-8 w-full mt-5 md:ps-12'>
                    <div className=''>
                      ...
                      <div className="flex flex-col gap-5">
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Our teams are driven by high standards, precision, and a relentless commitment to outperform expectations at every stage of the process.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">We believe excellence is achieved through consistency, discipline, and a continuous drive to improve and innovate.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">From ideation to execution, we refine, test, and perfect every product until it stands out as the best in its class.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">To us, excellence is not just about results; it’s about the mindset that pushes boundaries and inspires greatness in everything we do.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Through dedication and passion, we turn ordinary efforts into extraordinary achievements.</p>
                ...
                {activeTab === "tab3" && (
                  <div className='pt-8 w-full mt-5 md:ps-12'>
                    <div className=''>
                      ...
                      <div className="flex flex-col gap-5">
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Our culture thrives on respect, collaboration, and shared growth, where every voice matters and every idea is valued.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">We foster an environment that encourages learning, well-being, and balance — ensuring our teams feel inspired and supported in all they do.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Trust, empathy, and open communication define our relationships, both within our teams and with our clients.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">To us, putting people first means nurturing potential, recognizing achievements, and building a workplace where everyone can thrive.</p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Together, we grow stronger, driven by unity, purpose, and the belief that success begins with our people.</p>
                ...
                {activeTab === "tab4" && (
                  <div className='pt-8 w-full mt-5 md:ps-12'>
                    <div className=''>
                      ...
                      <div className="flex flex-col gap-5">
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Our approach is rooted in complete transparency; from project discussions to delivery milestones, ensuring our clients are always informed and confident in every decision.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">We value accountability and sincerity, standing by our words and actions to create meaningful, long-term collaborations.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">By embracing openness, we eliminate barriers, encourage genuine dialogue, and foster mutual respect across every level of engagement.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">To us, honesty and transparency are not just principles; they are promises that guide how we work, connect, and grow with our partners.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Together, we build partnerships defined by clarity, trust, and shared success.
                        </p>
                ...
                {activeTab === "tab5" && (
                  <div className='pt-8 w-full mt-5 md:ps-12'>
                    <div className=''>
                      ...
                      <div className="flex flex-col gap-5">
                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">We believe that true success is built on honesty, responsibility, and doing what’s right — even when no one is watching.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Our teams operate with fairness, respect, and accountability, fostering confidence among our clients, partners, and colleagues alike.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Every decision we make reflects our dedication to transparency and moral responsibility, shaping relationships rooted in trust and credibility.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">To us, integrity is more than a principle — it’s a promise to act with sincerity, honor our word, and inspire confidence through ethical excellence.
                        </p>

                        <p className="undefined text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-black">Through unwavering integrity, we strengthen our reputation and create a legacy of trust and respect.
                        </p>
      ...
      <section className="textContent-sec">
        <div className="px-6 lg:px-8 max-w-7xl mx-auto pt-14 md:pt-24 lg:pt-[10.5rem]">
          <div className="2xl:max-w-4xl lg:max-w-3xl">
            <div className="lg:overflow-hidden">
              <h2 className="pb-1 font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Brands Who Believe in Us</span></h2></div>
          </div>
        </div>
      </section>
        ...
        <div className="px-6 lg:px-8 pt-14 md:pt-24 lg:pt-[10.5rem] max-w-7xl mx-auto">
          <div className='lg:grid lg:grid-cols-12'>
            <div className='lg:col-span-7 xl:pr-4'>
              <div className='lg:overflow-hidden'>
                <h2 className=" undefined font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Life At Pine Techware - Our People & Culture</span></h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="textContent-sec">
        <div className="undefined px-6 lg:px-8 max-w-7xl mx-auto pt-14 md:pt-24 lg:pt-[10.5rem]">
          <div className="2xl:max-w-4xl lg:max-w-3xl">
            <div className="lg:overflow-hidden">
              <h2 className="pb-1 font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Award-Winning Journey</span></h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="leadingBrandAbout-sec bg-black lg:mt-[10.5rem] md:mt-24 mt-14">
        <div className="undefined px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
          <div className="lg:overflow-hidden">
            <h2 className="undefined text-white font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
      ...
      <section className="textContent-sec">
        <div className="px-6 lg:px-8 max-w-7xl mx-auto pt-14 md:pt-24 lg:pt-[10.5rem]">
          <div className="2xl:max-w-4xl lg:max-w-3xl">
            <div className="lg:overflow-hidden">
              <h2 className="undefined font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px] text-white"><span>Media Mentions</span></h2></div>
            <p className="pt-6 lg:pe-[5rem] lg:pt-[2.375rem] text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-white">We stay in the news for our incredible tech achievements to
        ...
        <div className="flex gap-5 md:gap-0 md:flex-nowrap justify-between flex-wrap lg:gap-10 mt-8">
          <div className="md:w-[33%] sm:w-[60%] w-full">
            <article className="mx-2 md:mx-4 px-6 mt-8 lg:mt-12 lg:mx-0 lg:px-6 relative" >
              ...
              <div>
                <p className="pt-10 text-white pr-[25px] text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">There's Finally a Dating App for People With Disabilities</p>
              </div>
      ...
      <section className="gameDev-sec bg-black text-white py-14 md:py-24 lg:py-[10.5rem]">
        <div className="px-6 lg:px-8 max-w-7xl mx-auto" >
          <div className="lg:overflow-hidden" >
            <h2 className="font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>The Values That Shape Us</span></h2></div>
      ...
      <section className="textContent-sec">
        <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem]">
          <div className="2xl:max-w-4xl lg:max-w-3xl">
            <div className="lg:overflow-hidden">
              <h2 className="pb-1 font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Meet the Team Behind Pine Techware</span></h2>
      ...
      <section className="textContent-sec">
        <div className="px-6 lg:px-8 max-w-7xl mx-auto pb-14 md:pb-24 lg:pb-[10.5rem]">
          <div className="2xl:max-w-4xl lg:max-w-3xl">
            <div className="lg:overflow-hidden">
              <h2 className="pb-1 font-bold sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl  lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Sales & Account Growth Team</span></h2>
