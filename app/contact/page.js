            ...
            <div className="px-6 lg:px-8 pt-12 md:pt-20 max-w-7xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5 sm:gap-x-10 sm:gap-y-10">
                    <div>
                        ...
                        <div>
                            <p className="  text-black mb-1 font-medium text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">Canada Address</p>
                            <p className="text-white mb-3 text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl"></p>
                            <p className="  text-neutral-500 font-medium leading-5 md:leading-6 text-xs xl:text-sm 2xl:text-base">R-10225 Yonge St, Suite #250, Richmond Hill, ON L4C 3B2</p>
                        </div>
                    </div>
                    <div>
                        <Image className="mb-5 md:mb-[46px] lg:rounded-[30px] rounded-2xl" src={florida} alt="Location" />
                        <div>
                            <p className=" text-black mb-1 font-medium text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">USA Address</p>
                            <p className=" text-white mb-3 text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl"></p>
                            <p className="  text-neutral-500 font-medium leading-5 md:leading-6 text-xs xl:text-sm 2xl:text-base">211 E 43rd St, 7th Floor, Suite #424, New York City, NY 10017</p>
                        </div>
                    </div>
