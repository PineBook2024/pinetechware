        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Immersive 3D Games Built for   </span>  Performance and Realism</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">3D games demand depth, realism, and flawless performance. We develop visually rich and technically advanced 3D games that deliver immersive gameplay, smooth mechanics, and engaging player experiences across platforms.</p>
                        </div>
                        <div className="lg:col-span-5 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
                                                              <Image
                                                                  src="/images/3D-Game-Development/01.webp"
                                                                  alt="Professional 3D Game Development Services"
                                                                  width={500}
                                                                  height={500}
                                                                  priority
                                                              ...
                                                              <Image src="/images/3D-Game-Development/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="3D Game Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
            ...
            <section className='bg-white'>
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem] ">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Full-Cycle 3D Game Development Services</span></h2></div>
