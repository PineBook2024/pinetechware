...
import Img1 from "@/public/images/banner-inner/Shopify-Store-banner.webp";
    ...
    const webServices = [
        {
            ...
            description:
                "Tailor-made Shopify stores designed around your brand, products, and growth goals.",
        },
        {
            heading: "Shopify Theme Design & Customization",
            description:
                "Pixel-perfect themes customized for performance, branding, and user experience.",
        },
        {
            heading: "Product Setup & Store Configuration",
            description:
                "Complete setup of products, collections, variants, pricing, and tax rules.",
        },
        {
            heading: "Payment & Shipping Integration",
            description:
                "Secure payment gateways and shipping configurations for smooth checkout.",
        },
        {
            heading: "Shopify App Integration",
            description:
                "Third-party and custom apps to extend store functionality and automation.",
        },
        {
            heading: "Conversion Optimization",
            description:
                "Optimized layouts, CTAs, and checkout flows to improve sales and reduce drop-offs.",
        },
    ];
    ...
    const processSteps = [
        {
            ...
            desc: "We understand your products, audience, and sales objectives.",
        },
        {
            number: "02",
            title: "Store Strategy & Planning",
            desc: "We define store structure, navigation, and conversion paths.",
        },
        {
            number: "03",
            title: "Design & Development",
            desc: "Custom designs and Shopify development aligned with your brand identity.",
        },
        {
            number: "04",
            title: "App & Feature Integration",
            desc: "We integrate required tools for payments, shipping, marketing, and analytics.",
        },
        {
            number: "05",
            title: "Testing & Optimization",
            desc: "We test speed, responsiveness, checkout flow, and user experience.",
        },
        {
            number: "06",
            title: "Store Launch",
            desc: "Your Shopify store goes live with final configurations and quality checks.",
        },
        {
            number: "07",
            title: "Growth & Scaling Support",
            desc: "Ongoing optimization, feature upgrades, and scaling assistance.",
        },
    ];
        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Build High-Converting </span>  Shopify Stores That Scale</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">Shopify is powerful when built right. We design and develop Shopify stores that are fast, conversion-focused, and easy to manage—helping you sell more while keeping operations simple.</p>
                        </div>
                        <div className="lg:col-span-5 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
                                                              <Image
                                                                  src="/images/Shopify-Store/01.webp"
                                                                  alt="Shopify Store Services"
                                                                  width={500}
                                                                  height={500}
                                                                  priority
                                                              ...
                                                              <Image src="/images/Shopify-Store/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Shopify Store Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
            ...
            <section className='bg-white'>
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem] ">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Full-Cycle Shopify Store Services</span></h2></div>
