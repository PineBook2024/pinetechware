...
import Img1 from "@/public/images/banner-inner/Search-Engine-Optimization-banner.webp";
...
export default function page() {
    ...
    const webServices = [
        {
            heading: "SEO Strategy & Planning",
            description:
                "Custom SEO roadmaps based on your business goals, competition, and target audience.",
        },
        {
            heading: "Keyword Research & Analysis",
            description:
                "High-intent keyword research focused on traffic, relevance, and conversion potential.",
        },
        {
            heading: "On-Page SEO Optimization",
            description:
                "Optimizing website content, meta tags, headings, URLs, images, and internal linking.",
        },
        {
            heading: "Technical SEO",
            description:
                "Improving site speed, mobile responsiveness, crawlability, indexing, and core web vitals.",
        },
        {
            heading: "Content Optimization & SEO Copywriting",
            description:
                "SEO-friendly content that ranks well while remaining engaging and user-focused.",
        },
        {
            heading: "Link Building & Authority Growth",
            description:
                "High-quality backlinks to improve domain authority and search rankings.",
        },
    ];
    ...
    const processSteps = [
        {
            ...
            desc: "We analyze your website, competitors, industry, and current rankings.",
        },
        {
            number: "02",
            title: "SEO Strategy Development",
            desc: "We define keyword targets, content plans, and technical priorities.",
        },
        {
            number: "03",
            title: "On-Page & Technical Implementation",
            desc: "We optimize your website structure, pages, and backend elements.",
        },
        {
            number: "04",
            title: "Content & Authority Building",
            desc: "We enhance content quality and build trusted backlinks.",
        },
        {
            number: "05",
            title: "Monitoring & Optimization",
            desc: "We track rankings, traffic, and performance metrics continuously.",
        },
        {
            number: "06",
            title: "Reporting & Insights",
            desc: "Clear, easy-to-understand reports showing progress and ROI.",
        },
        {
            number: "07",
            title: "Long-Term Growth Strategy",
            desc: "We refine and scale SEO efforts to maintain and grow rankings over time.",
        },
    ];
        ...
        <div>
                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                            <div className="overflow-hidden">
                                <h1 className=" font-bold text-black pb-6 lg:pb-[2.375rem]  text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span className='text-theme text-[#3BB9E1]'>Get Found Where   </span>  Your Customers Are Searching</h1></div>
                            <p className="   text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">SEO is not about shortcuts. It’s about building long-term visibility, credibility, and traffic. We help your business rank higher on search engines, attract the right audience, and convert organic traffic into real growth.</p>
                        </div>
                        <div className="lg:col-span-5 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
                                                              <Image
                                                                  src="/images/Search-Engine-Optimization/01.webp"
                                                              ...
                                                              <Image src="/images/Search-Engine-Optimization/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Search Engine Optimization Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
            ...
            <section className='bg-white'>
                <div className="px-6 lg:px-8 max-w-7xl mx-auto py-14 md:py-24 lg:py-[10.5rem] ">
                    <div className="lg:overflow-hidden">
                        <h2 className="text-black font-bold pb-2 md:pb-0 sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>Our Full-Cycle SEO Services</span></h2></div>
