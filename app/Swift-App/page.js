                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        <div className="lg:col-span-7">
                         ...
                         <div className="lg:col-span-5 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
                                                               <Image
                                                                   src="/images/Swift-App/01.webp"
                                                                   alt="Professional Swift App Development Services"
                                                                   width={500}
                                                                   height={500}
                                                                   priority
                                                               ...
                                                               <Image src="/images/Swift-App/02.webp" sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 1440px) 1440px, 1920px" alt="Professional Swift App Development Services" className="w-full object-cover max-w-full h-auto" width="1920" height="1080" />
