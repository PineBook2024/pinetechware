    ...
    () => [
      {
        ...
        items: [
          { name: "Website Designing", href: "/website-designing-services", icon: FaLaptopCode },
          { name: "Website Development", href: "/website-development-services", icon: FaCode },
          { name: "E-Commerce Solution", href: "/e-commerce-solution", icon: FaShoppingCart },
          { name: "Custom Application", href: "/custom-application-services", icon: FaCode },
          { name: "Shopify Store", href: "/shopify-store-development", icon: FaShopify },
          { name: ".Net Application", href: "/asp-net-development", icon: FaMicrosoft },
        ],
      },
      {
        category: "Mob App Development",
        items: [
          { name: "iOS App", href: "/ios-app-development-services", icon: FaApple },
          { name: "Android App", href: "/android-app-development-services", icon: FaAndroid },
          { name: "Kotlin App", href: "/kotlin-app-development", icon: FaJava },
          { name: "React Native App", href: "/react-native-app", icon: FaReact },
          { name: "Flutter App", href: "/flutter-app-development-services", icon: FaFire },
          { name: "Swift App", href: "/swift-app-development", icon: FaApple },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Logo Designs", href: "/logo-design-services", icon: FaPenNib },
          { name: "Professional Branding", href: "/branding-services", icon: FaIdBadge },
          { name: "Video Animation", href: "/video-animation-services", icon: FaVideo },
        ],
      },
    ],
    []
